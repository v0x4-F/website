...
$(document).ready(function()
{
	...
	//  Moving projects judged by window size.
	//window.onresize = setColByWinSize;
	...
	// Page navigation
	var isTopCurrentPage = true;
	var issimCurrentPage = false;
	...
	$("#topPage, #logo").click(function()
		{
			if(!isTopCurrentPage)
			{
				isTopCurrentPage = true;
				issimCurrentPage = false;
				isAboutCurrentPage = false;
				$("#topPage").attr("class", "currentPage");
				$("#simPage").removeClass("currentPage");
	...
	$("#simPage").click(function()
		{
			if(!issimCurrentPage)
			{
				isTopCurrentPage = false;
				issimCurrentPage = true;
				isAboutCurrentPage = false;
				$("#simPage").attr("class", "currentPage");
				$("#topPage").removeClass("currentPage");
				$("#aboutPage").removeClass("currentPage");
	...
	$(".projectThumbnail").click(function(e) {
		...
		if( !projectEl.data('slider-inited') ) {
			...
			if(portfolioSliderData.length > 0) {
				...
				$("#logo, #topPage, #rsPage").click(function() {
					function bugFix() {
